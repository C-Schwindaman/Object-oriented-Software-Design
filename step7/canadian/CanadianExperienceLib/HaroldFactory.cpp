...
std::shared_ptr<Actor> HaroldFactory::Create(std::wstring imagesDir)
{
    ...
    headt->SetLeftEye(wxPoint(42, 79));
    headt->SetRightEye(wxPoint(69, 79));
    headt->SetStartLeftEyebrow(wxPoint(46, 59));
    headt->SetStartRightEyebrow(wxPoint(63, 59));
    headt->SetEndLeftEyebrow(wxPoint(32, 63));
    headt->SetEndRightEyebrow(wxPoint(78, 62));
