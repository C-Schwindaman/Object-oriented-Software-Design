 ...
 */
    ...
    private:
        ...
        void DrawColorPolygon(std::shared_ptr<wxGraphicsContext> graphics, double x, double y);
        void DrawImagePolygon(std::shared_ptr<wxGraphicsContext> graphics, double x, double y);
    ...
    public:
        ...
        void DrawPolygon(std::shared_ptr<wxGraphicsContext> graphics, double x, double y);

        /**
         * Set rotation to the polygon.
         * @param rotation rotation value in radian
        */
        virtual void SetRotation(double rotation) { mRotation = rotation; }

        /**
         * Get rotation of the polygon.
         * @return rotation value in radian
        */
        double GetRotation() { return mRotation; }

        /**
         * Set phase of the polygon.
         * @param phase phase value
        */
        void SetPhase(double phase) { mPhase = phase; }

        /**
         * Get phase of the polygon.
         * @return phase value
        */
