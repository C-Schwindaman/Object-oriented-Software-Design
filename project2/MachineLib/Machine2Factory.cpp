...
std::shared_ptr<Machine> Machine2Factory::Create()
{
    ...
    blower->SetBubbleDirection(true);
    blower->SetBubbleDExpansion(true);
 ...
 * @return Shape object
 */
std::shared_ptr<Shape> Machine2Factory::CreatePost(int x, int y, int wid, int hit)
{
